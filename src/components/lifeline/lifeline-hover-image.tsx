		...
		<LifelineHoverImageContext.Provider value={api}>
			...
			>
				...
				<img
					ref={imageRef}
					alt=""
					className="w-70 scale-95 rounded-xl shadow-2xl ring-1 ring-black/10 transition-[transform,box-shadow] duration-200 ease-out dark:ring-white/15"
					decoding="async"
				/>
				<video
					ref={videoRef}
					...
					className="max-h-80 w-auto max-w-70 scale-95 rounded-xl shadow-2xl ring-1 ring-black/10 transition-[transform,box-shadow] duration-200 ease-out dark:ring-white/15"
					style={{ display: "none" }}
				/>
			</div>
