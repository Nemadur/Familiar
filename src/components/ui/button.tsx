...
const buttonVariants = cva(
	"group/button inline-flex cursor-pointer shrink-0 items-center justify-center rounded-full border border-transparent! bg-clip-padding text-sm font-normal whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				default:
				...
				secondary:
					"bg-secondary text-secondary-foreground hover:bg-secondary/80 selection:bg-secondary-foreground/12",
				ghost:
					"hover:bg-muted focus-visible:bg-muted focus-visible:text-muted-foreground aria-expanded:bg-muted aria-expanded:text-foreground",
				blur_light:
