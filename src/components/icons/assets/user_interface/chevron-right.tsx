...
export const OutlineChevronRight: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
...
export const SolidChevronRight: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
...
export const DuotoneChevronRight: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
