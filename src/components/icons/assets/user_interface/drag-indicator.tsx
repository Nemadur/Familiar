...
export const OutlineDragIndicator: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
...
export const SolidDragIndicator: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
...
export const DuotoneDragIndicator: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
