...
export const OutlineImport: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
	...
	>
		...
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M8.293 12.707a1 1 0 1 1 1.414-1.414L11 12.586V4a1 1 0 1 1 2 0v8.586l1.293-1.293a1 1 0 0 1 1.414 1.414l-3 3a1 1 0 0 1-1.414 0l-3-3Z"
			fill="currentColor"
		/>
	</svg>
);

export const SolidImport: React.FC<IconProps> = ({ className, size = 24 }) => (
	<svg
		width={size}
		height={size}
		viewBox="0 0 24 24"
