...
export const OutlineQestionMarkCrFr: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
...
export const SolidQestionMarkCrFr: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
...
export const DuotoneQestionMarkCrFr: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
