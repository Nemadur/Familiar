...
export const OutlineMonitor: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M13 17h-2v2H8a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-3v-2Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
...
export const SolidMonitor: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
