...
export const OutlineRepeat02: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
...
export const SolidRepeat02: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
...
export const DuotoneRepeat02: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M17.293 18.707a1 1 0 0 0 1.414 0l3-3a1 1 0 0 0-1.414-1.414L18 16.586l-2.293-2.293a1 1 0 0 0-1.414 1.414l3 3Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
      ...
      d="M6 5a1 1 0 0 0-1 1v10a4 4 0 0 0 4 4h2a1 1 0 1 0 0-2H9a2 2 0 0 1-2-2V6a1 1 0 0 0-1-1Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
