...
export const OutlineFileText: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
	...
	>
		...
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M9 12a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H9Zm0 4a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2H9Z"
			fill="currentColor"
		/>
	</svg>
);

export const SolidFileText: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
...
export const DuotoneFileText: React.FC<IconProps> = ({
	className,
	size = 24,
	style,
}) => (
	...
	>
		...
		<path
			fillRule="evenodd"
			clipRule="evenodd"
			d="M9 12a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H9Zm0 4a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2H9Zm5-12.586a1.414 1.414 0 0 1 2.414-1l3.172 3.172a1.414 1.414 0 0 1-1 2.414H16a2 2 0 0 1-2-2V3.414Z"
			fill="currentColor"
		/>
	</svg>
);
