...
export const OutlineFileText2: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 11a1 1 0 1 0 0 2h1v4a1 1 0 1 0 2 0v-4h1a1 1 0 1 0 0-2h-4Z"
      fill="currentColor"
    />
  </svg>
);

export const SolidFileText2: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
...
export const DuotoneFileText2: React.FC<IconProps> = ({
  className,
  size = 24,
}) => (
  <svg
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 11a1 1 0 1 0 0 2h1v4a1 1 0 1 0 2 0v-4h1a1 1 0 1 0 0-2h-4Zm4-7.586a1.414 1.414 0 0 1 2.414-1l3.172 3.172a1.414 1.414 0 0 1-1 2.414H16a2 2 0 0 1-2-2V3.414Z"
      fill="currentColor"
    />
  </svg>
);
