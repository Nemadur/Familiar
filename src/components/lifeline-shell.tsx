...
export function LifelineShell({
	...
	return (
		<div
			className={cn(
				"flex pb-18 h-dvh flex-col overflow-hidde antialiased transition-colors duration-300", //h-[calc(100dvh-16rem)]
				className,
			)}
		>
			{children}
		...
		>
			...
			>
				<a
					...
					className="transition-[color,opacity] duration-300 hover:opacity-70"
				>
					{logo}
				</a>
...
export function LifelineFooter({
	...
	return (
		<footer
			className={cn(
				"shrink-0 backdrop-blur-sm transition-colors duration-300",
				className,
			)}
		>
			<div
